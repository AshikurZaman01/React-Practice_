...
const Country = ({ country, handleVisitedCountries, handleCisitedCountriesName, handleVisitedFlag }) => {
    ...
    return (
        <div>
            <div className="my-10">
                ...
                <div>
                    <button onClick={() => { handleVisited; handleVisitedFlag(country) }} className={visited ? "btn bg-green-500" : "btn bg-red-400"} >{visited ? "visited" : "Not Visited"}</button>
                </div>
