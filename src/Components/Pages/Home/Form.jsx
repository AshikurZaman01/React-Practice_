...
const Form = ({ title, btnSubmit = "Submit", handleSubmit, nameRef, ageRef, passwordRef }) => {
    ...
    return (
        <div className="flex justify-center items-center h-[80vh] ">
            ...
            <form onClick={handleSubmit} className="w-[300px] bg-blue-300 p-5">
                ...
                <div><h1 className="text-3xl pb-5 text-center font-extrabold">{title}</h1></div>
                ...
                <div>
                    <button className="btn btn-sm w-full btn-info">{btnSubmit}</button>
                </div>
